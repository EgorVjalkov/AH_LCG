from game_data.fast_token_value import players
from game_data.tokens_n_bags import camp_dict, std_dict
...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!здесь проблемы!!!!!!!!!!!!!
# меняю механизм составлению сумки
...
def find_a_scenario():
    ...
    while True:
        q_start_of_name = text_in_color(
            f'Input a few first letters of a name of scenario !without article! and press "enter" or write "all" ',
            'fat')
